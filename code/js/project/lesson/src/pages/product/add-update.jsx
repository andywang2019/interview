...
import {reqCategorys, reqAddOrUpdateProduct, reqUrlCategorys, reqUrlAddOrUpdateProduct} from '../../api'
import withRouter from "../../utils/withRouter";

const {Item} = Form
const { TextArea } = Input

const url="/api/manage/category/list"
/*
Product的添加和更新的子路由组件
 */
  ...
  submit = () => {
    ...
    this.form.current.validateFields().then(async ( values) => {
     // if (!error) {
        ...
        const detail = this.editor.current.value//getDetail()
...
<Input type='number' placeholder='请输入商品价格' addonAfter='元'/>
          ...
          <Item label="商品详情" labelCol={{span: 2}} wrapperCol={{span: 20}}>
            <Input ref={this.editor} detail={detail}/>
          </Item>
          <Item>
